...
public class HighCardComparingImplTest extends TestCase {
    ...
    public void testComparing() {
        Card card1 = new Card(CardSuitEnum.DIAMONDS, CardRankEnum.CARD_QUEUE);
        ...
        Card card6 = new Card(CardSuitEnum.CLUBS, CardRankEnum.CARD_ACE);
        Card card7 = new Card(CardSuitEnum.HEARTS, CardRankEnum.CARD_JACK);
